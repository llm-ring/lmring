...
const openaiChatModels: ChatModelCard[] = [
  {
    ...
    description:
      "GPT-5.6 Sol is OpenAI's latest flagship and most capable model, optimized for coding and agentic work.",
    type: 'chat',
  ...
  },
  {
    ...
    description: 'GPT-5.6 Terra balances intelligence and cost for everyday professional work.',
    type: 'chat',
    contextWindowTokens: 1_050_000,
    maxOutput: 128_000,
    enabled: true,
